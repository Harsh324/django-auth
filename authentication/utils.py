...
def send_activation_email(recipient_email, activation_url):
    ...
    html_content = render_to_string('authentication/activation_email.html', {'activation_url' : activation_url})
...
def send_reset_password_email(recipient_email, reset_url):
    ...
    # Load the HTML template
    html_content = render_to_string('authentication/reset_password_email.html', {'reset_url': reset_url})
